...
- **Desired outcome:** keep `validation/scripts/validate.py` + `validation/src/` a reliable “usability proof” of the in-tree build, and (optionally) a practical integration test bed.
- **Constraints:**
