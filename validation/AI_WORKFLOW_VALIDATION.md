...
- **Desired outcome:** keep `validation/scripts/validate.py` + `validation/src/rocm_validation/` a reliable “usability proof” of the in-tree build, and (optionally) a practical integration test bed.
- **Constraints:**
...
- Add/modify steps in `validation/src/rocm_validation/steps/`:
