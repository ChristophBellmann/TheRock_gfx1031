...
from therock_validation.cli.prompts import confirm
from therock_validation.core.config import load_config
from therock_validation.core.context import Context
from therock_validation.core.reporting.summary import print_summary
from therock_validation.steps.plan import build_plan, run_plan
...
def _cmd_cache_gc(argv: list[str]) -> int:
    ...
    args = ap.parse_args(argv)
    from therock_validation.core.artifacts import cache_gc  # lazy
...
def _cmd_report(argv: list[str]) -> int:
    ...
    args = ap.parse_args(argv)
    from therock_validation.core.artifacts import open_last_report  # lazy
