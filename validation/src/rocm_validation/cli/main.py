...
from rocm_validation.cli.prompts import confirm
from rocm_validation.core.config import load_config
from rocm_validation.core.context import Context
from rocm_validation.core.reporting.summary import print_summary
from rocm_validation.steps.plan import build_plan, run_plan
...
def _cmd_cache_gc(argv: list[str]) -> int:
    ...
    args = ap.parse_args(argv)
    from rocm_validation.core.artifacts import cache_gc  # lazy
...
def _cmd_report(argv: list[str]) -> int:
    ...
    args = ap.parse_args(argv)
    from rocm_validation.core.artifacts import open_last_report  # lazy
